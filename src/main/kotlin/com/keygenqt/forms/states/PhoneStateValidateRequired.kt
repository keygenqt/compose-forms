...
import com.keygenqt.forms.validation.getErrorIsNotPhone

/**
 * State with validate phone and required
 *
 * @since 0.0.2
 * @author Vitaliy Zarubin
 */
class PhoneStateValidateRequired : FormFieldState(checkValid = { target: String ->
    listOfNotNull(
